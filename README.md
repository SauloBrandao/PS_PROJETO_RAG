...
Isso deve abrir um site no seu navegador, hospedado localmente no seu computador. Caso queira alterar a database basta deletar a database 
padrão e criar uma nova passando o PDF da sua escolha.
